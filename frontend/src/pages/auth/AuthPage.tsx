...
export const AuthPage = () => {
  ...
  return (
    <div className={classes.authContainer}>
      <img src="/login.png" className={classes.authImage} alt="Login" />
      <div className={classes.authDiv}>
        <img src="/logo.svg" className={classes.authLogo} alt="Logo" />
        ...
        <div className={classes.inputContainer}>
            ...
            <div style={{
              ...
              <div style={{ marginTop: '12px' }}>
                ...
                <Button
                  ...
                  outlined
                  onClick={() => {
                    form.setFieldsValue({ username: 'testuser', password: 'test123' });
                  }}
                  style={{ fontSize: '12px' }}
                />
              </div>
          ...
          <div style={{
            ...
            API Endpoint: {process.env.REACT_APP_API_URL || 'http://localhost:5050'}
          </div>
        </div>
      </div>
    </div>
